...
- 当前版本：`0.4.26`，详细变更见 [更新日志](CHANGELOG.md)。
...
发送 `帮助` 查看基础菜单，发送 `娱乐帮助` 查看娱乐菜单，发送 `计算帮助` 查看计算器菜单。`0.4.26` 已补齐任务目标、奖励、赛季组成、命运契约和任务资料统计查询。
...
- [x] 任务资料库查询（任务线、任务搜索、详情、目标、奖励、树状关系、赛季阶段/分组、命运契约和 26 类统计）
- [x] 货币信息查询
