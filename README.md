...
- 当前版本：`0.4.25`，详细变更见 [更新日志](CHANGELOG.md)。
...
发送 `帮助` 查看基础菜单，发送 `娱乐帮助` 查看娱乐菜单，发送 `计算帮助` 查看计算器菜单。`0.4.24` 接入任务资料库查询；`0.4.25` 继续补齐任务线详情、树状关系和赛季任务详情。
...
- [x] 任务资料库查询（任务线、任务搜索、任务详情、任务线详情、树状关系、赛季任务线和赛季任务详情）
- [x] 货币信息查询
