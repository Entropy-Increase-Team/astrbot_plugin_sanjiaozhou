...
- 当前版本：`0.4.27`，详细变更见 [更新日志](CHANGELOG.md)。
...
发送 `帮助` 查看基础菜单，发送 `娱乐帮助` 查看娱乐菜单，发送 `计算帮助` 查看计算器菜单。`0.4.27` 已补齐收集任务分组、奖励、槽位和随机任务查询。
...
- [x] 任务资料库查询（任务线、搜索、详情、目标、奖励、树状关系、赛季与命运契约、收集任务和 26 类统计）
- [x] 货币信息查询
